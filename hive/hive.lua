...
local system_cell = assert(package.searchpath("system", package.path), "system cell was not found")
local socket_cell = assert(package.searchpath("network", package.path), "socket cell was not found")
